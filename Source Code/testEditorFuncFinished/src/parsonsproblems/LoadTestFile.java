...
public class LoadTestFile extends javax.swing.JFrame {
    ...
    static String[][] trueAnswers = new String[10][3];
    static String[][] falseAnswers = new String[10][6];
    //The 2 below will only be modified if loading a save file
    static boolean[] completedQs;
    static int[] marks;
    static int[] currentPoints;
    //to be editied if the amount of questions is ever changed
    static int NoOfQuestions = 10;
    /**
    ...
    public LoadTestFile(int setMode) {
        ...
        if(mode == 0){
            ...
            completedQs = new boolean[]{false, false, false, false, false, false, false, false, false, false};
        ...
        if(mode == 1){
            ...
            marks = new int[10];
            completedQs = new boolean[NoOfQuestions];
            currentPoints = new int[NoOfQuestions];
            getFileNamesOnTable();
        }
