...
public class Summary extends javax.swing.JFrame {
     ...
     */
    public Summary(String[] inQTextArray, String[][] inTrueAnswers, String[][] inFalseAnswers,int [] inMarks) {
    ...
    private void writeFile(String inContent, String inFilename) throws IOException{
        FileWriter writer = new FileWriter("./TESTDATA/Results/RESULTS--" + inFilename);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        // checks if any of the individual characters "\/:*?"<> or |"are used in the filename text box and throws an error message if found
            ...
            String fileContent = "-----------------------------\n"
                               ...
                               + "THIS FILE WILL BE USED IN A LATER VERSION \n"
                               + "-----------------------------\n"
                               + "-----------------------------\n"
                               + "Name : " + name + "\n"
                               + "Marks : \n"
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Summary(qTextArray, trueAnswers, falseAnswers, marks).setVisible(true);
            }
        });
    }
