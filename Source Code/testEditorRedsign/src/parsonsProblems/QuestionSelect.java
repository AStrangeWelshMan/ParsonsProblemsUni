...
public class QuestionSelect extends javax.swing.JFrame {
    ...
    */
    public QuestionSelect(String inTestName, String[] inQTextArray, String[][] inTrueAnswers, String[][] inFalseAnswers, int[] updatedMarks, boolean[] updatedBoolList, int[] inCurrentPoints) {
        initComponents();
        testName = inTestName;
    ...
    private void startQuestion1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion1ActionPerformed
        if(completedQs[0] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 0, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
    ...
    private void quitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quitButtonActionPerformed
        AreYouSure youSure = new AreYouSure(testName, qTextArray, trueAnswers, falseAnswers, marks, completedQs, currentPoints);
    ...
    private void startQuestion2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion2ActionPerformed
        if(completedQs[1] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 1, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion3ActionPerformed
        if(completedQs[2] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 2, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion4ActionPerformed
        if(completedQs[3] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 3, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion5ActionPerformed
        if(completedQs[4] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 4, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion6ActionPerformed
        if(completedQs[5] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 5, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion7ActionPerformed
        if(completedQs[6] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 6, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion8ActionPerformed
        if(completedQs[7] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 7, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion9ActionPerformed
        if(completedQs[8] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 8, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion10ActionPerformed
        if(completedQs[9] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(testName, 9, qTextArray, marks, trueAnswers, falseAnswers, completedQs, currentPoints);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
