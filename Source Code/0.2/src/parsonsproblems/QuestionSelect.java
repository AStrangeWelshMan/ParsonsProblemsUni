 ...
 * In this iteration this will initialize the inbuilt test and give the required   
*/
...
public class QuestionSelect extends javax.swing.JFrame {
    ...
    // This will run everytime the user returns to the question select screen,
    // this will assign the marks array to the updated array received from the 
    // question UI 

    /**
     * @param updatedMarks The updated marks given to the Question Select UI by the question UI once the user quits the question
     * @param updatedBoolList
    */
    public QuestionSelect(int[] updatedMarks, boolean[] updatedBoolList) {
        initComponents();
        marks = updatedMarks;
        ...
        while(i < marks.length){
            temp = temp + marks[i];
            totalMarksDisp.setText(temp + "/50");
            i++;
        }
    }
    //initInbuilt functions will be moved to their own method once file integration begins
    int[] marks;
    String[] qTextArray = initInbuiltQText();
    String[][] trueAnswers = initInbuiltTrueList();
    String[][] falseAnswers = initInbuiltFalseList();
    
    // The boolean array qCompleted will be used to say whether or not the 
    boolean[] completedQs;
    ...
    private static String[] initInbuiltQText(){
        ...
        String q2Text = "<html> Question 2 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q3Text = "<html> Question 3 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q4Text = "<html> Question 4 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q5Text = "<html> Question 5 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q6Text = "<html> Question 6 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q7Text = "<html> Question 7 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q8Text = "<html> Question 8 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q9Text = "<html> Question 9 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
        String q10Text = "<html> Question 10 Order these numbers in order <br/> <br/> one of the answers, is not a number, place this in the false answer box";
    ...
    //generic, will be used in both cases of using inbuilt and imported tests
    ...
    private void startQuestion1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion1ActionPerformed
        if(completedQs[0] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(1, qTextArray[0], marks, trueAnswers[0], falseAnswers[0], completedQs);
            QUI.setVisible(true);
    ...
    private void startQuestion2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion2ActionPerformed
        if(completedQs[1] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(2, qTextArray[1], marks, trueAnswers[1], falseAnswers[1], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion3ActionPerformed
        if(completedQs[2] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(3, qTextArray[2], marks, trueAnswers[2], falseAnswers[2], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion4ActionPerformed
        if(completedQs[3] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(4, qTextArray[3], marks, trueAnswers[3], falseAnswers[3], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion5ActionPerformed
        if(completedQs[4] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(5, qTextArray[4], marks, trueAnswers[4], falseAnswers[4], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion6ActionPerformed
        if(completedQs[5] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(6, qTextArray[5], marks, trueAnswers[5], falseAnswers[5], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion7ActionPerformed
        if(completedQs[6] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(7, qTextArray[6], marks, trueAnswers[6], falseAnswers[6], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion8ActionPerformed
        if(completedQs[7] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(8, qTextArray[7], marks, trueAnswers[7], falseAnswers[7], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion9ActionPerformed
        if(completedQs[8] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(9, qTextArray[8], marks, trueAnswers[8], falseAnswers[8], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
    ...
    private void startQuestion10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startQuestion10ActionPerformed
        if(completedQs[9] == false){
            ParsonsProblemsQUI QUI = new ParsonsProblemsQUI(10, qTextArray[9], marks, trueAnswers[9], falseAnswers[9], completedQs);
            QUI.setVisible(true);
            //disable the close (x) button for the question UI
            QUI.setDefaultCloseOperation(QUI.DO_NOTHING_ON_CLOSE);
            this.setVisible(false);
